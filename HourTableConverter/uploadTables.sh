...
curl -su "bot:$(cat '../nc_api_bot_password.cred')" -H OCS-APIRequest:true -X MKCOL "https://warmulla.kaleidox.de/remote.php/dav/files/bot/Stunden%20$targetYear" 2> /dev/null | xq\
  && (curl -su "bot:$(cat '../nc_api_bot_password.cred')" -H OCS-APIRequest:true -X POST 'https://warmulla.kaleidox.de/ocs/v2.php/apps/files_sharing/api/v1/shares'\
     ...
     -d 'permissions=31' 1> /dev/null 2> /dev/null)\
